// Header.jsx - Global Header with Logo, Search Bar, and Clear All Pill
// Enhanced navigation with search functionality and filter management
// Version: 1.0.0
          ...
          <div className="flex items-center space-x-4">
            ...
            {hasActiveFilters && (
              <button
                ...
                className="inline-flex items-center px-3 py-1.5 rounded-full text-sm font-medium bg-red-100 text-red-800 hover:bg-red-200 transition-colors duration-200"
              >
